 ...
 * Generated for Laravel 7.4.0 on 2020-04-01 01:19:59.
 *
...
namespace Illuminate\Support\Facades {
    ...
    use Exception;
    use Freeloaders\Console\Kernel;
    use Freeloaders\User;
    use Generator;
    ...
    class Blade {
        ...
        {
                        return BladeCompiler::compileClassComponentOpening($component, $data, $hash);
        }
